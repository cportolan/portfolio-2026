    ...
    <div className="min-h-screen bg-[var(--background)] text-[var(--foreground)]">
      <main className="mx-auto w-full max-w-5xl space-y-12 px-6 py-20 sm:px-10">
        <header className="space-y-4">
          ...
          <h1 className="text-4xl font-semibold sm:text-5xl">{content.heading}</h1>
          <p className="max-w-2xl text-lg text-[var(--gray-300)]">{content.intro}</p>
        </header>
          ...
          {projects.map((project) => (
            ...
            >
              <div className="flex items-center justify-between">
                <h2 className="text-2xl font-semibold">{project.title[locale]}</h2>
